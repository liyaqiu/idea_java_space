 ...
 **/
@Slf4j
public class _7多分支流程走向控制_通过TaskId设置Global变量 {
    ...
    public void 获取个人待执行任务方式1(){
        ...
        for (Task task : taskList) {
            ...
            processEngine.getTaskService().setVariable(task.getId(),"leaveForm",leaveForm);
            //方式2
            //processEngine.getTaskService().setVariables();
