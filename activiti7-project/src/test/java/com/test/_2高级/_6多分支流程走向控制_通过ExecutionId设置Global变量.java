 ...
 **/
@Slf4j
public class _6多分支流程走向控制_通过ExecutionId设置Global变量 {
    ...
    public void 获取个人待执行任务方式1(){
        ...
        for (Task task : taskList) {
            ...
            processEngine.getRuntimeService().setVariable(task.getExecutionId(),"leaveForm",leaveForm);
            //方式2
            //processEngine.getRuntimeService().setVariables();
    ...
    * */
    ...
    public void 仓库_级联删除部署(){
        RepositoryService repositoryService = processEngine.getRepositoryService();
        repositoryService.deleteDeployment("130001",true);
    }
}
