/*
 ...
 Source Server         : 192.168.88.10
 Source Server Type    : MySQL
 Source Server Version : 50725
 Source Host           : 192.168.88.10:3306
 Source Schema         : guli
...
CREATE TABLE `acl_permission`  (
  ...
  `parent_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属上级',
  `title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '名称',
  `type` tinyint(1) NULL DEFAULT 0 COMMENT '类型(0:菜单,1:按钮)',
  `permit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '权限值',
  `component` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组件路径',
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `hidden` tinyint(1) NULL DEFAULT NULL COMMENT '隐藏 0 false ， 1 true',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '导航路由名字',
...
-- ----------------------------
INSERT INTO `acl_permission` VALUES ('a0', NULL, '讲师管理', 0, NULL, 'Layout', 'el-icon-menu', 0, 'teacher', '/teacher', 20, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a1', 'a0', '添加讲师', 0, 'teacher.add', '/Teacher/AddTeacher', 'el-icon-edit', 0, 'addteacher', 'addteacher', 22, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a10', 'a5', '删除课程', 1, 'course.delete', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a11', 'a5', '修改课程', 1, 'course.update', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a2', 'a0', '删除讲师', 1, 'teacher.delete', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a3', 'a0', '修改讲师', 0, 'teacher.update', '/Teacher/AddTeacher', NULL, 1, 'updateteacher', 'updateteacher/:id', 23, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a4', 'a0', '讲师列表', 0, 'teacher.list', '/Teacher/TeacherList', 'el-icon-view', 0, 'teacherlist', 'teacherlist', 21, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a5', NULL, '课程管理', 0, NULL, 'Layout', 'el-icon-menu', 0, 'course', '/course', 10, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a6', 'a5', '添加课程', 0, 'course.add', '/Course/AddCourse/CourseBasic', 'el-icon-edit', 0, 'coursebasic', 'coursebasic', 12, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a7', 'a5', '添加课程', 0, NULL, '/Course/AddCourse/CourseOutline', NULL, 1, 'courseoutline', 'courseoutline/:courseId', 13, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a8', 'a5', '添加课程', 0, NULL, '/Course/AddCourse/CoursePublish', NULL, 1, 'coursepublish', 'coursepublish/:courseId', 14, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
INSERT INTO `acl_permission` VALUES ('a9', 'a5', '课程别表', 0, 'course.list', '/Course/CourseList', 'el-icon-view', 0, 'courselist', 'courselist', 11, 0, 0, '2022-10-05 13:27:47', '2022-10-05 13:27:47');
...
CREATE TABLE `acl_role`  (
  ...
  `status` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '状态(0:禁止,1:正常)',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of acl_role
-- ----------------------------
INSERT INTO `acl_role` VALUES ('11', '超级管理员', 'admin', '这个角色是超级管理员哦，什么都可以操作的', 1, 0, '2022-10-05 13:26:02', '2022-10-05 13:26:02');
INSERT INTO `acl_role` VALUES ('22', '普通管理员', 'eric', '除了系统管理模块，其他权限都有', 0, 0, '2022-10-05 13:26:02', '2022-10-05 13:26:02');
INSERT INTO `acl_role` VALUES ('33', '大厅经理', 'broker', '这个是负责打杂的', 1, 0, '2022-10-05 13:26:02', '2022-10-10 13:03:21');
...
CREATE TABLE `acl_role_permission`  (
  ...
  `role_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `permission_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `acl_role_permission` VALUES ('s0', '11', 'a0', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s1', '11', 'a1', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s10', '11', 'a10', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s11', '11', 'a11', 0, NULL, NULL);
INSERT INTO `acl_role_permission` VALUES ('s2', '11', 'a2', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s3', '11', 'a3', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s4', '11', 'a4', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s5', '11', 'a5', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s6', '11', 'a6', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s7', '11', 'a7', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s8', '11', 'a8', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
INSERT INTO `acl_role_permission` VALUES ('s9', '11', 'a9', 0, '2022-10-07 13:18:51', '2022-10-07 13:18:51');
...
CREATE TABLE `acl_user`  (
  ...
  `locked` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '锁定用户 0 false 未锁定， 1 true锁定',
...
-- Records of acl_user
-- ----------------------------
INSERT INTO `acl_user` VALUES ('1', 'admin', '020daee8a4aaad1f8e147278687308ac', '系统管理员', 'https://fu5.web.sdo.com/10036/202209/16644161922791.gif', 0, '361234567@qq.com', '13421724028', '2022-10-05 13:23:56', '2022-10-05 13:23:58');
INSERT INTO `acl_user` VALUES ('2', 'eric', '020daee8a4aaad1f8e147278687308ac', 'Mr.Li', 'https://fu5.web.sdo.com/10036/202210/16649470338775.gif', 1, '361234567@qq.com', '18813664703', '2022-10-05 13:23:56', '2022-10-05 13:23:56');
...
CREATE TABLE `acl_user_role`  (
  ...
  `role_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '角色id',
  `user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '用户id',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `acl_user_role` VALUES ('1579740861085278210', '11', '1', 0, '2022-10-11 15:49:06', '2022-10-11 15:49:06');
INSERT INTO `acl_user_role` VALUES ('1579740861093666818', '33', '1', 0, '2022-10-11 15:49:06', '2022-10-11 15:49:06');
INSERT INTO `acl_user_role` VALUES ('1579754716800770049', '11', '2', 0, '2022-10-11 16:44:10', '2022-10-11 16:44:10');

-- ----------------------------
-- Table structure for bak_acl_permission
-- ----------------------------
DROP TABLE IF EXISTS `bak_acl_permission`;
CREATE TABLE `bak_acl_permission`  (
  `id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '编号',
  `parent_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '所属上级',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '名称',
  `type` tinyint(3) NULL DEFAULT 0 COMMENT '类型(0:目录,1:菜单,2:按钮)',
  `permit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '权限值',
  `component` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组件路径',
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问路径',
...
-- ----------------------------
-- Records of bak_acl_permission
-- ----------------------------
INSERT INTO `bak_acl_permission` VALUES ('1', '0', '全部数据', 0, '', '', '', '', NULL, 0, '2019-11-15 17:13:06', '2019-11-15 17:13:06');
INSERT INTO `bak_acl_permission` VALUES ('111', '11', '', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `bak_acl_permission` VALUES ('1111', '111', '', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `bak_acl_permission` VALUES ('11111', '1111', '', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `bak_acl_permission` VALUES ('1195268474480156673', '1', '权限管理', 1, NULL, 'Layout', NULL, '/acl', NULL, 0, '2019-11-15 17:13:06', '2019-11-18 13:54:25');
INSERT INTO `bak_acl_permission` VALUES ('1195268616021139457', '1195268474480156673', '用户管理', 1, NULL, '/acl/user/list', NULL, 'user/list', NULL, 0, '2019-11-15 17:13:40', '2019-11-18 13:53:12');
INSERT INTO `bak_acl_permission` VALUES ('1195268788138598401', '1195268474480156673', '角色管理', 1, NULL, '/acl/role/list', NULL, 'role/list', NULL, 0, '2019-11-15 17:14:21', '2019-11-15 17:14:21');
INSERT INTO `bak_acl_permission` VALUES ('1195268893830864898', '1195268474480156673', '菜单管理', 1, NULL, '/acl/menu/list', NULL, 'menu/list', NULL, 0, '2019-11-15 17:14:46', '2019-11-15 17:14:46');
INSERT INTO `bak_acl_permission` VALUES ('1195269143060602882', '1195268616021139457', '查看', 2, 'user.list', '', NULL, '', NULL, 0, '2019-11-15 17:15:45', '2019-11-17 21:57:16');
INSERT INTO `bak_acl_permission` VALUES ('1195269295926206466', '1195268616021139457', '添加', 2, 'user.add', '/acl/user/form', NULL, 'user/add', NULL, 0, '2019-11-15 17:16:22', '2019-11-15 17:16:22');
INSERT INTO `bak_acl_permission` VALUES ('1195269473479483394', '1195268616021139457', '修改', 2, 'user.update', '/acl/user/form', NULL, 'user/update/:id', NULL, 0, '2019-11-15 17:17:04', '2019-11-15 17:17:04');
INSERT INTO `bak_acl_permission` VALUES ('1195269547269873666', '1195268616021139457', '删除', 2, 'user.remove', '', NULL, '', NULL, 0, '2019-11-15 17:17:22', '2019-11-15 17:17:22');
INSERT INTO `bak_acl_permission` VALUES ('1195269821262782465', '1195268788138598401', '修改', 2, 'role.update', '/acl/role/form', NULL, 'role/update/:id', NULL, 0, '2019-11-15 17:18:27', '2019-11-15 17:19:53');
INSERT INTO `bak_acl_permission` VALUES ('1195269903542444034', '1195268788138598401', '查看', 2, 'role.list', '', NULL, '', NULL, 0, '2019-11-15 17:18:47', '2019-11-15 17:18:47');
INSERT INTO `bak_acl_permission` VALUES ('1195270037005197313', '1195268788138598401', '添加', 2, 'role.add', '/acl/role/form', NULL, 'role/add', NULL, 0, '2019-11-15 17:19:19', '2019-11-18 11:05:42');
INSERT INTO `bak_acl_permission` VALUES ('1195270442602782721', '1195268788138598401', '删除', 2, 'role.remove', '', NULL, '', NULL, 0, '2019-11-15 17:20:55', '2019-11-15 17:20:55');
INSERT INTO `bak_acl_permission` VALUES ('1195270621548568578', '1195268788138598401', '角色权限', 2, 'role.acl', '/acl/role/roleForm', NULL, 'role/distribution/:id', NULL, 0, '2019-11-15 17:21:38', '2019-11-15 17:21:38');
INSERT INTO `bak_acl_permission` VALUES ('1195270744097742849', '1195268893830864898', '查看', 2, 'permission.list', '', NULL, '', NULL, 0, '2019-11-15 17:22:07', '2019-11-15 17:22:07');
INSERT INTO `bak_acl_permission` VALUES ('1195270810560684034', '1195268893830864898', '添加', 2, 'permission.add', '', NULL, '', NULL, 0, '2019-11-15 17:22:23', '2019-11-15 17:22:23');
INSERT INTO `bak_acl_permission` VALUES ('1195270862100291586', '1195268893830864898', '修改', 2, 'permission.update', '', NULL, '', NULL, 0, '2019-11-15 17:22:35', '2019-11-15 17:22:35');
INSERT INTO `bak_acl_permission` VALUES ('1195270887933009922', '1195268893830864898', '删除', 2, 'permission.remove', '', NULL, '', NULL, 0, '2019-11-15 17:22:41', '2019-11-15 17:22:41');
INSERT INTO `bak_acl_permission` VALUES ('1195349439240048642', '1', '讲师管理', 1, '', 'Layout', NULL, '/teacher', NULL, 0, '2019-11-15 22:34:49', '2019-11-15 22:34:49');
INSERT INTO `bak_acl_permission` VALUES ('1195349699995734017', '1195349439240048642', '讲师列表', 1, NULL, '/edu/teacher/list', NULL, 'table', NULL, 0, '2019-11-15 22:35:52', '2019-11-15 22:35:52');
INSERT INTO `bak_acl_permission` VALUES ('1195349810561781761', '1195349439240048642', '添加讲师', 1, NULL, '/edu/teacher/save', NULL, 'save', NULL, 0, '2019-11-15 22:36:18', '2019-11-15 22:36:18');
INSERT INTO `bak_acl_permission` VALUES ('1195349876252971010', '1195349810561781761', '添加', 2, 'teacher.add', '', NULL, '', NULL, 0, '2019-11-15 22:36:34', '2019-11-15 22:36:34');
INSERT INTO `bak_acl_permission` VALUES ('1195349979797753857', '1195349699995734017', '查看', 2, 'teacher.list', '', NULL, '', NULL, 0, '2019-11-15 22:36:58', '2019-11-15 22:36:58');
INSERT INTO `bak_acl_permission` VALUES ('1195350117270261762', '1195349699995734017', '修改', 2, 'teacher.update', '/edu/teacher/save', NULL, 'edit/:id', NULL, 0, '2019-11-15 22:37:31', '2019-11-15 22:37:31');
INSERT INTO `bak_acl_permission` VALUES ('1195350188359520258', '1195349699995734017', '删除', 2, 'teacher.remove', '', NULL, '', NULL, 0, '2019-11-15 22:37:48', '2019-11-15 22:37:48');
INSERT INTO `bak_acl_permission` VALUES ('1195350299365969922', '1', '课程分类', 1, NULL, 'Layout', NULL, '/subject', NULL, 0, '2019-11-15 22:38:15', '2019-11-15 22:38:15');
INSERT INTO `bak_acl_permission` VALUES ('1195350397751758850', '1195350299365969922', '课程分类列表', 1, NULL, '/edu/subject/list', NULL, 'list', NULL, 0, '2019-11-15 22:38:38', '2019-11-15 22:38:38');
INSERT INTO `bak_acl_permission` VALUES ('1195350500512206850', '1195350299365969922', '导入课程分类', 1, NULL, '/edu/subject/save', NULL, 'save', NULL, 0, '2019-11-15 22:39:03', '2019-11-15 22:39:03');
INSERT INTO `bak_acl_permission` VALUES ('1195350612172967938', '1195350397751758850', '查看', 2, 'subject.list', '', NULL, '', NULL, 0, '2019-11-15 22:39:29', '2019-11-15 22:39:29');
INSERT INTO `bak_acl_permission` VALUES ('1195350687590748161', '1195350500512206850', '导入', 2, 'subject.import', '', NULL, '', NULL, 0, '2019-11-15 22:39:47', '2019-11-15 22:39:47');
INSERT INTO `bak_acl_permission` VALUES ('1195350831744782337', '1', '课程管理', 1, NULL, 'Layout', NULL, '/course', NULL, 0, '2019-11-15 22:40:21', '2019-11-15 22:40:21');
INSERT INTO `bak_acl_permission` VALUES ('1195350919074385921', '1195350831744782337', '课程列表', 1, NULL, '/edu/course/list', NULL, 'list', NULL, 0, '2019-11-15 22:40:42', '2019-11-15 22:40:42');
INSERT INTO `bak_acl_permission` VALUES ('1195351020463296513', '1195350831744782337', '发布课程', 1, NULL, '/edu/course/info', NULL, 'info', NULL, 0, '2019-11-15 22:41:06', '2019-11-15 22:41:06');
INSERT INTO `bak_acl_permission` VALUES ('1195351159672246274', '1195350919074385921', '完成发布', 2, 'course.publish', '/edu/course/publish', NULL, 'publish/:id', NULL, 0, '2019-11-15 22:41:40', '2019-11-15 22:44:01');
INSERT INTO `bak_acl_permission` VALUES ('1195351326706208770', '1195350919074385921', '编辑课程', 2, 'course.update', '/edu/course/info', NULL, 'info/:id', NULL, 0, '2019-11-15 22:42:19', '2019-11-15 22:42:19');
INSERT INTO `bak_acl_permission` VALUES ('1195351566221938690', '1195350919074385921', '编辑课程大纲', 2, 'chapter.update', '/edu/course/chapter', NULL, 'chapter/:id', NULL, 0, '2019-11-15 22:43:17', '2019-11-15 22:43:17');
INSERT INTO `bak_acl_permission` VALUES ('1195351862889254913', '1', '统计分析', 1, NULL, 'Layout', NULL, '/sta', NULL, 0, '2019-11-15 22:44:27', '2019-11-15 22:44:27');
INSERT INTO `bak_acl_permission` VALUES ('1195351968841568257', '1195351862889254913', '生成统计', 1, NULL, '/sta/create', NULL, 'create', NULL, 0, '2019-11-15 22:44:53', '2019-11-15 22:44:53');
INSERT INTO `bak_acl_permission` VALUES ('1195352054917074946', '1195351862889254913', '统计图表', 1, NULL, '/sta/show', NULL, 'show', NULL, 0, '2019-11-15 22:45:13', '2019-11-15 22:45:13');
INSERT INTO `bak_acl_permission` VALUES ('1195352127734386690', '1195352054917074946', '查看', 2, 'daily.list', '', NULL, '', NULL, 0, '2019-11-15 22:45:30', '2019-11-15 22:45:30');
INSERT INTO `bak_acl_permission` VALUES ('1195352215768633346', '1195351968841568257', '生成', 2, 'daily.add', '', NULL, '', NULL, 0, '2019-11-15 22:45:51', '2019-11-15 22:45:51');
INSERT INTO `bak_acl_permission` VALUES ('1195352547621965825', '1', 'CMS管理', 1, NULL, 'Layout', NULL, '/cms', NULL, 0, '2019-11-15 22:47:11', '2019-11-18 10:51:46');
INSERT INTO `bak_acl_permission` VALUES ('1195352856645701633', '1195353513549205505', '查看', 2, 'banner.list', NULL, NULL, '', NULL, 0, '2019-11-15 22:48:24', '2019-11-15 22:48:24');
INSERT INTO `bak_acl_permission` VALUES ('1195352909401657346', '1195353513549205505', '添加', 2, 'banner.add', '/cms/banner/form', NULL, 'banner/add', NULL, 0, '2019-11-15 22:48:37', '2019-11-18 10:52:10');
INSERT INTO `bak_acl_permission` VALUES ('1195353051395624961', '1195353513549205505', '修改', 2, 'banner.update', '/cms/banner/form', NULL, 'banner/update/:id', NULL, 0, '2019-11-15 22:49:11', '2019-11-18 10:52:05');
INSERT INTO `bak_acl_permission` VALUES ('1195353513549205505', '1195352547621965825', 'Bander列表', 1, NULL, '/cms/banner/list', NULL, 'banner/list', NULL, 0, '2019-11-15 22:51:01', '2019-11-18 10:51:29');
INSERT INTO `bak_acl_permission` VALUES ('1195353672110673921', '1195353513549205505', '删除', 2, 'banner.remove', '', NULL, '', NULL, 0, '2019-11-15 22:51:39', '2019-11-15 22:51:39');
INSERT INTO `bak_acl_permission` VALUES ('1195354076890370050', '1', '订单管理', 1, NULL, 'Layout', NULL, '/order', NULL, 0, '2019-11-15 22:53:15', '2019-11-15 22:53:15');
INSERT INTO `bak_acl_permission` VALUES ('1195354153482555393', '1195354076890370050', '订单列表', 1, NULL, '/order/list', NULL, 'list', NULL, 0, '2019-11-15 22:53:33', '2019-11-15 22:53:58');
INSERT INTO `bak_acl_permission` VALUES ('1195354315093282817', '1195354153482555393', '查看', 2, 'order.list', '', NULL, '', NULL, 0, '2019-11-15 22:54:12', '2019-11-15 22:54:12');
INSERT INTO `bak_acl_permission` VALUES ('1196301740985311234', '1195268616021139457', '分配角色', 2, 'user.assgin', '/acl/user/roleForm', NULL, 'user/role/:id', NULL, 0, '2019-11-18 13:38:56', '2019-11-18 13:38:56');

-- ----------------------------
-- Table structure for bak_acl_role
-- ----------------------------
DROP TABLE IF EXISTS `bak_acl_role`;
CREATE TABLE `bak_acl_role`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '角色id',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '角色名称',
  `code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色编码',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
...
-- ----------------------------
-- Records of bak_acl_role
-- ----------------------------
INSERT INTO `bak_acl_role` VALUES ('1', '超级管理员', 'normal', '只有基本查看功能', 0, '2019-11-11 13:09:32', '2020-08-21 11:59:37');
INSERT INTO `bak_acl_role` VALUES ('1193757683205607426', '课程管理员', 'normal', '只有基本查看功能', 0, '2019-11-11 13:09:45', '2019-11-18 10:25:44');
INSERT INTO `bak_acl_role` VALUES ('1296656642959503361', '讲师管理员', 'admin', '无所不能', 0, '2020-08-21 11:53:29', '2020-08-21 11:59:51');
INSERT INTO `bak_acl_role` VALUES ('1296658571068469249', '普通管理员', 'normal', '只有基本查看功能', 0, '2020-08-21 12:01:09', '2020-08-21 12:01:09');

-- ----------------------------
-- Table structure for bak_acl_role_permission
-- ----------------------------
DROP TABLE IF EXISTS `bak_acl_role_permission`;
CREATE TABLE `bak_acl_role_permission`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `role_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `permission_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
...
-- ----------------------------
-- Records of bak_acl_role_permission
-- ----------------------------
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702601695234', '1', '1', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702652026881', '1', '1195268474480156673', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702668804098', '1', '1195268616021139457', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702698164226', '1', '1195269143060602882', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702723330049', '1', '1195269295926206466', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702744301569', '1', '1195269473479483394', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702765273089', '1', '1195269547269873666', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702790438913', '1', '1196301740985311234', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702945628161', '1', '1195268788138598401', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312702970793985', '1', '1195269821262782465', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703000154114', '1', '1195269903542444034', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703025319938', '1', '1195270037005197313', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703046291458', '1', '1195270442602782721', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703063068673', '1', '1195270621548568578', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703084040193', '1', '1195268893830864898', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703113400321', '1', '1195270744097742849', 0, '2019-11-18 14:22:29', '2019-11-18 14:22:29');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703134371842', '1', '1195270810560684034', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703159537665', '1', '1195270862100291586', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703184703490', '1', '1195270887933009922', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703209869313', '1', '1195349439240048642', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703230840834', '1', '1195349699995734017', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703251812354', '1', '1195349979797753857', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703272783873', '1', '1195350117270261762', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703293755394', '1', '1195350188359520258', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703327309826', '1', '1195349810561781761', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703348281345', '1', '1195349876252971010', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703365058561', '1', '1195350299365969922', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703386030082', '1', '1195350397751758850', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703440556034', '1', '1195350612172967938', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703486693378', '1', '1195350500512206850', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703511859202', '1', '1195350687590748161', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703654465537', '1', '1195350831744782337', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703683825665', '1', '1195350919074385921', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703700602882', '1', '1195351159672246274', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703717380098', '1', '1195351326706208770', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703738351618', '1', '1195351566221938690', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703759323137', '1', '1195351020463296513', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703776100353', '1', '1195351862889254913', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703792877570', '1', '1195351968841568257', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703830626305', '1', '1195352215768633346', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703843209217', '1', '1195352054917074946', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703868375041', '1', '1195352127734386690', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703889346561', '1', '1195352547621965825', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703901929473', '1', '1195353513549205505', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703918706689', '1', '1195352856645701633', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703952261121', '1', '1195352909401657346', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703973232642', '1', '1195353051395624961', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312703990009857', '1', '1195353672110673921', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312704048730114', '1', '1195354076890370050', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312704069701633', '1', '1195354153482555393', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1196312704094867457', '1', '1195354315093282817', 0, '2019-11-18 14:22:30', '2019-11-18 14:22:30');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198312292353', '1296341621322825729', '1195268474480156673', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198333263873', '1296341621322825729', '1195268616021139457', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198333263874', '1296341621322825729', '1195269143060602882', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198333263875', '1296341621322825729', '1195269295926206466', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198341652482', '1296341621322825729', '1195269473479483394', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198341652483', '1296341621322825729', '1195269547269873666', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198341652484', '1296341621322825729', '1196301740985311234', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198341652485', '1296341621322825729', '1195268788138598401', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198350041090', '1296341621322825729', '1195269821262782465', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198350041091', '1296341621322825729', '1195269903542444034', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198354235393', '1296341621322825729', '1195270037005197313', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198354235394', '1296341621322825729', '1195270442602782721', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198358429698', '1296341621322825729', '1195270621548568578', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198358429699', '1296341621322825729', '1195268893830864898', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198358429700', '1296341621322825729', '1195270744097742849', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198358429701', '1296341621322825729', '1195270810560684034', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198366818305', '1296341621322825729', '1195270862100291586', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296342198366818306', '1296341621322825729', '1195270887933009922', 0, '2020-08-20 15:04:00', '2020-08-20 15:04:00');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752510529537', '1296656642959503361', '1195350299365969922', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752523112449', '1296656642959503361', '1195350397751758850', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752523112450', '1296656642959503361', '1195350612172967938', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752523112451', '1296656642959503361', '1195350500512206850', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752527306754', '1296656642959503361', '1195350687590748161', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752527306755', '1296656642959503361', '1195350831744782337', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752527306756', '1296656642959503361', '1195350919074385921', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752531501058', '1296656642959503361', '1195351159672246274', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752535695362', '1296656642959503361', '1195351326706208770', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752535695363', '1296656642959503361', '1195351566221938690', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296656752535695364', '1296656642959503361', '1195351020463296513', 0, '2020-08-21 11:53:55', '2020-08-21 11:53:55');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379854344194', '1193757683205607426', '1195350831744782337', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379862732801', '1193757683205607426', '1195350919074385921', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379862732802', '1193757683205607426', '1195351159672246274', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379862732803', '1193757683205607426', '1195351326706208770', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379866927106', '1193757683205607426', '1195351566221938690', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658379871121410', '1193757683205607426', '1195351020463296513', 0, '2020-08-21 12:00:23', '2020-08-21 12:00:23');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628543016962', '1296658571068469249', '1195349439240048642', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628547211266', '1296658571068469249', '1195349699995734017', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628547211267', '1296658571068469249', '1195349979797753857', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628547211268', '1296658571068469249', '1195350117270261762', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405570', '1296658571068469249', '1195350188359520258', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405571', '1296658571068469249', '1195349810561781761', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405572', '1296658571068469249', '1195349876252971010', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405573', '1296658571068469249', '1195350299365969922', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405574', '1296658571068469249', '1195350397751758850', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405575', '1296658571068469249', '1195350612172967938', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405576', '1296658571068469249', '1195350500512206850', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405577', '1296658571068469249', '1195350687590748161', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405578', '1296658571068469249', '1195350831744782337', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405579', '1296658571068469249', '1195350919074385921', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405580', '1296658571068469249', '1195351159672246274', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405581', '1296658571068469249', '1195351326706208770', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405582', '1296658571068469249', '1195351566221938690', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405583', '1296658571068469249', '1195351020463296513', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405584', '1296658571068469249', '1195351862889254913', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405585', '1296658571068469249', '1195351968841568257', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405586', '1296658571068469249', '1195352215768633346', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405587', '1296658571068469249', '1195352054917074946', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405588', '1296658571068469249', '1195352127734386690', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405589', '1296658571068469249', '1195352547621965825', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405590', '1296658571068469249', '1195353513549205505', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405591', '1296658571068469249', '1195352856645701633', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405592', '1296658571068469249', '1195352909401657346', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405593', '1296658571068469249', '1195353051395624961', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405594', '1296658571068469249', '1195353672110673921', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405595', '1296658571068469249', '1195354076890370050', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658628551405596', '1296658571068469249', '1195354153482555393', 0, '2020-08-21 12:01:22', '2020-08-21 12:01:22');
INSERT INTO `bak_acl_role_permission` VALUES ('1296658631705522177', '1296658571068469249', '1195354315093282817', 0, '2020-08-21 12:01:23', '2020-08-21 12:01:23');

-- ----------------------------
-- Table structure for bak_acl_user
-- ----------------------------
DROP TABLE IF EXISTS `bak_acl_user`;
CREATE TABLE `bak_acl_user`  (
  `id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '会员id',
  `username` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '微信openid',
...
-- ----------------------------
-- Records of bak_acl_user
-- ----------------------------
INSERT INTO `bak_acl_user` VALUES ('1', 'admin', '96e79218965eb72c92a549dd5a330112', 'admin', '', NULL, 0, '2019-11-01 10:39:47', '2019-11-01 10:39:47');
INSERT INTO `bak_acl_user` VALUES ('1296657852869406722', 'yang', '96e79218965eb72c92a549dd5a330112', '龙达达', NULL, NULL, 0, '2020-08-21 11:58:18', '2020-08-21 11:58:18');
INSERT INTO `bak_acl_user` VALUES ('1296658810076688386', 'long', '96e79218965eb72c92a549dd5a330112', '龙达达1', NULL, NULL, 0, '2020-08-21 12:02:06', '2020-08-21 12:02:06');

-- ----------------------------
-- Table structure for bak_acl_user_role
-- ----------------------------
DROP TABLE IF EXISTS `bak_acl_user_role`;
CREATE TABLE `bak_acl_user_role`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '主键id',
  `role_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '角色id',
  `user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '用户id',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
...
-- ----------------------------
-- Records of bak_acl_user_role
-- ----------------------------
INSERT INTO `bak_acl_user_role` VALUES ('1', '1', '2', 0, '2019-11-11 13:09:53', '2019-11-11 13:09:53');
INSERT INTO `bak_acl_user_role` VALUES ('1296343056387198977', '1296341621322825729', '1296342997553696769', 0, '2020-08-20 15:07:24', '2020-08-20 15:07:24');
INSERT INTO `bak_acl_user_role` VALUES ('1296657892589465601', '1296656642959503361', '1296657852869406722', 0, '2020-08-21 11:58:27', '2020-08-21 11:58:27');
INSERT INTO `bak_acl_user_role` VALUES ('1296659019410206722', '1296658571068469249', '1296658810076688386', 0, '2020-08-21 12:02:56', '2020-08-21 12:02:56');
...
INSERT INTO `crm_banner` VALUES ('1194607458461216763', 'test3', 'https://online-teach-file.oss-cn-beijing.aliyuncs.com/cms/2019/11/13/8f80790d-d736-4842-a6a4-4dcb0d684d4e.jpg', '/teacher', 2, 0, '2019-11-13 21:26:27', '2019-11-14 09:12:15');
INSERT INTO `crm_banner` VALUES ('1194607458461216769', 'test2', 'https://online-teach-file.oss-cn-beijing.aliyuncs.com/cms/2019/11/14/297acd3b-b592-4cfb-a446-a28310369675.jpg', '/teacher', 2, 0, '2019-11-13 21:26:27', '2019-11-14 09:12:15');
...
CREATE TABLE `edu_chapter`  (
  ...
  `course_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '课程ID',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '章节名称',
...
INSERT INTO `edu_chapter` VALUES ('1568150695310491649', '11', '第一章节13', 1, '2022-09-09 16:13:55', '2022-09-10 14:15:58');
INSERT INTO `edu_chapter` VALUES ('1568150759898578946', '11', '第二章节', 0, '2022-09-09 16:14:11', '2022-09-09 16:14:11');
INSERT INTO `edu_chapter` VALUES ('1568150779972517890', '11', '第三章节', 0, '2022-09-09 16:14:15', '2022-09-09 16:14:15');
INSERT INTO `edu_chapter` VALUES ('1568475968551747585', '11', '444', 0, '2022-09-10 13:46:26', '2022-09-10 13:46:26');
INSERT INTO `edu_chapter` VALUES ('1568476646426771458', '11', '4444', 1, '2022-09-10 13:49:08', '2022-09-10 13:49:08');
INSERT INTO `edu_chapter` VALUES ('1568534299043667969', '1568534125978296322', '12312', 0, '2022-09-10 17:38:14', '2022-09-10 17:38:14');
INSERT INTO `edu_chapter` VALUES ('1571388587221024770', '1571388543096946690', '第一章', 0, '2022-09-18 14:40:09', '2022-09-18 14:40:09');
INSERT INTO `edu_chapter` VALUES ('1571388608188350465', '1571388543096946690', '第二章', 0, '2022-09-18 14:40:14', '2022-09-18 14:40:14');
INSERT INTO `edu_chapter` VALUES ('1571388747380523009', '1571388543096946690', '第三章', 0, '2022-09-18 14:40:47', '2022-09-18 14:40:47');
INSERT INTO `edu_chapter` VALUES ('1578639093278511106', '1578635306908323842', '12', 0, '2022-10-08 14:51:04', '2022-10-08 14:51:04');
...
-- ----------------------------
INSERT INTO `edu_course` VALUES ('11', '1189426437876985857', '1567385261002969089', '1567385260981997569', 'java基础课程', 0.00, 2, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/06/587d5686663541d986a750be8c9b99b9java.jpg', 4, 387, 1, 'Normal', 0, '2019-11-07 09:27:33', '2022-09-10 15:51:17');
...
INSERT INTO `edu_course` VALUES ('1291293802446819330', '', '1293200126810021889', '1293200126793244674', 'mysql高级优化', 0.00, 55, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/06/587d5686663541d986a750be8c9b99b9java.jpg', 0, 0, 1, 'Draft', NULL, '2020-08-06 16:43:28', '2020-08-06 16:43:28');
...
INSERT INTO `edu_course` VALUES ('1568194835591077890', NULL, '1567385261036523522', '1567385260981997569', '123123', 1.00, 1, NULL, 0, 0, 1, 'Draft', NULL, '2022-09-09 19:09:19', '2022-09-09 19:09:19');
INSERT INTO `edu_course` VALUES ('1568197499343261698', '1189426464967995393', '1567385261002969089', '1567385260981997569', '测试122233333', 1.00, 1, 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/2022/09/09/50e27d8816884cd491e372ce927f7049-nihao.jpg', 0, 0, 1, 'Normal', NULL, '2022-09-09 19:19:54', '2022-09-10 20:04:23');
INSERT INTO `edu_course` VALUES ('1568534125978296322', '1189426437876985857', '1567385261002969089', '1567385260981997569', '123213', 1.00, 30, 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/2022/09/10/7a06ddf2c73c42dc957f2c4a1968a261-nihao.jpg', 0, 0, 1, 'Normal', NULL, '2022-09-10 17:37:32', '2022-09-10 17:38:38');
INSERT INTO `edu_course` VALUES ('1568555361965940737', NULL, NULL, NULL, '123123', 1.00, 1, NULL, 0, 0, 1, 'Draft', NULL, '2022-09-10 19:01:55', '2022-09-10 19:01:55');
INSERT INTO `edu_course` VALUES ('1568570962587402242', NULL, NULL, NULL, '123', 1.00, 1, NULL, 0, 0, 1, 'Draft', NULL, '2022-09-10 20:03:55', '2022-09-10 20:03:55');
INSERT INTO `edu_course` VALUES ('1571388543096946690', '2', '1567385261078466562', '1567385260981997569', 'springcloud开发视频', 0.00, 60, 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/2022/09/18/1c15459c75ce4632a12209341da6f047-nihao.jpg', 0, 0, 1, 'Draft', NULL, '2022-09-18 14:39:58', '2022-09-18 14:39:58');
INSERT INTO `edu_course` VALUES ('1578635306908323842', NULL, NULL, NULL, NULL, 1.00, 1, NULL, 0, 0, 1, 'Draft', NULL, '2022-10-08 14:36:01', '2022-10-08 14:36:01');
INSERT INTO `edu_course` VALUES ('1578639441313468418', NULL, NULL, NULL, NULL, 1.00, 1, NULL, 0, 0, 1, 'Draft', NULL, '2022-10-08 14:52:27', '2022-10-08 14:53:25');
INSERT INTO `edu_course` VALUES ('18', '1290647121648709633', '1567385261036523522', '1567385260981997569', 'Java精品课程', 60.00, 60, 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/2022/09/18/ab7099f5c34f4073930bff896fd52e91-nihao.jpg', 151, 737, 6, 'Normal', 0, '2018-04-02 21:28:46', '2022-09-18 14:38:35');
...
-- ----------------------------
INSERT INTO `edu_course_description` VALUES ('1', '<p><u><strong>这是精品课程</strong></u></p>', '2022-09-18 14:39:58', '2022-09-18 14:39:58');
INSERT INTO `edu_course_description` VALUES ('11', '<p><s><u><em><strong>123123</strong></em></u></s></p>', '2022-09-09 18:20:23', '2022-09-10 15:51:17');
INSERT INTO `edu_course_description` VALUES ('1568165931421769730', '<p><br></p>', '2022-09-09 17:14:28', '2022-09-09 17:14:28');
INSERT INTO `edu_course_description` VALUES ('1568169052281741314', '<p><br></p>', '2022-09-09 17:26:52', '2022-09-09 17:26:52');
INSERT INTO `edu_course_description` VALUES ('1568169680693338113', '<p><br></p>', '2022-09-09 17:29:22', '2022-09-09 17:29:22');
INSERT INTO `edu_course_description` VALUES ('1568194835591077890', '<p><br></p>', '2022-09-09 19:09:19', '2022-09-09 19:09:19');
INSERT INTO `edu_course_description` VALUES ('1568197499343261698', '<p><u><strong>123213123213123</strong></u></p>', '2022-09-09 19:19:54', '2022-09-10 20:04:23');
INSERT INTO `edu_course_description` VALUES ('1568534125978296322', '<p><br></p>', '2022-09-10 17:37:32', '2022-09-10 17:38:38');
INSERT INTO `edu_course_description` VALUES ('1568555361965940737', '<p>123</p>', '2022-09-10 19:01:55', '2022-09-10 19:01:55');
INSERT INTO `edu_course_description` VALUES ('1568570962587402242', '<p><br></p>', '2022-09-10 20:03:55', '2022-09-10 20:03:55');
INSERT INTO `edu_course_description` VALUES ('1571388543096946690', '<ul><li><span style=\"color: rgb(231, 95, 51); font-size: 29px;\"><u><em><strong>123123123</strong></em></u></span></li></ul>', '2022-09-09 17:13:45', '2022-09-09 17:13:45');
INSERT INTO `edu_course_description` VALUES ('1578635306908323842', '<p>123123</p>', '2022-10-08 14:36:01', '2022-10-08 14:36:01');
INSERT INTO `edu_course_description` VALUES ('1578639441313468418', '<p>121211</p>', '2022-10-08 14:52:27', '2022-10-08 14:53:25');
...
CREATE TABLE `edu_subject`  (
  ...
  `parent_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父ID',
...
-- ----------------------------
INSERT INTO `edu_subject` VALUES ('1567385260981997569', '前端开发', NULL, 0, '2022-09-06 13:32:21', '2022-09-07 13:32:21');
INSERT INTO `edu_subject` VALUES ('1567385261002969089', 'vue', '1567385260981997569', 0, '2022-09-07 13:32:21', '2022-09-07 13:32:21');
INSERT INTO `edu_subject` VALUES ('1567385261036523522', 'JavaScript', '1567385260981997569', 0, '2022-09-07 13:32:21', '2022-09-07 13:32:21');
INSERT INTO `edu_subject` VALUES ('1567385261078466562', 'jquery', '1567385260981997569', 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
INSERT INTO `edu_subject` VALUES ('1567385261095243778', '后端开发', NULL, 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
INSERT INTO `edu_subject` VALUES ('1567385261112020994', 'Java', '1567385261095243778', 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
INSERT INTO `edu_subject` VALUES ('1567385261137186817', 'c++', '1567385261095243778', 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
INSERT INTO `edu_subject` VALUES ('1567385261153964033', '数据库开发', NULL, 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
INSERT INTO `edu_subject` VALUES ('1567385261170741249', 'mysql', '1567385261153964033', 0, '2022-09-07 13:32:22', '2022-09-07 13:32:22');
...
CREATE TABLE `edu_teacher`  (
  `id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '讲师ID',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '讲师姓名',
  `intro` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '讲师简介',
...
-- ----------------------------
INSERT INTO `edu_teacher` VALUES ('1189426437876985857', '王二', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/25f411209c8b44b9b003482b6265c3c9file.png', 0, 0, '2019-10-30 14:18:56', '2019-11-12 13:37:35');
INSERT INTO `edu_teacher` VALUES ('1189426464967995393', '王五', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/25f411209c8b44b9b003482b6265c3c9file.png', 0, 0, '2019-10-30 14:19:02', '2019-11-12 13:37:18');
INSERT INTO `edu_teacher` VALUES ('1192249914833055746', '李四', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '初级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/25f411209c8b44b9b003482b6265c3c9file.png', 0, 0, '2019-11-07 09:18:25', '2019-11-12 13:37:01');
INSERT INTO `edu_teacher` VALUES ('1290646470801776642', '张武', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '初级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/25f411209c8b44b9b003482b6265c3c9file.png', 1, 0, '2020-08-04 21:51:12', '2020-08-04 21:51:12');
INSERT INTO `edu_teacher` VALUES ('1290647121648709633', '王麻子', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '初级讲师', 1, 'https://online-teach-file.oss-cn-beijing.aliyuncs.com/teacher/2019/11/08/e44a2e92-2421-4ea3-bb49-46f2ec96ef88.png', 1, 0, '2020-08-04 21:53:48', '2020-08-04 21:53:48');
INSERT INTO `edu_teacher` VALUES ('1290670160830558210', '哈嘿嘿', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '中级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 1, 0, '2020-08-04 23:25:20', '2022-09-05 17:15:40');
INSERT INTO `edu_teacher` VALUES ('1566713106133065729', 'string1111', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 2, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 1, 0, '2022-09-05 17:01:27', '2022-09-05 17:15:55');
INSERT INTO `edu_teacher` VALUES ('1566716779110268930', '111', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '初级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 1, 0, '2022-09-05 17:16:03', '2022-09-05 17:16:03');
INSERT INTO `edu_teacher` VALUES ('1566716828728885249', '12313', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 1, 0, '2022-09-05 17:16:15', '2022-09-05 17:16:15');
INSERT INTO `edu_teacher` VALUES ('1567103829646905346', 'testimg', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 1, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 2, 0, '2022-09-06 18:54:03', '2022-09-06 21:26:30');
INSERT INTO `edu_teacher` VALUES ('2', '周杰伦', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '中级讲师', 1, 'https://guli-file-190513.oss-cn-beijing.aliyuncs.com/avatar/default.jpg', 0, 0, '2020-08-02 16:54:17', '2020-08-02 16:54:21');
INSERT INTO `edu_teacher` VALUES ('66', '廖晓悦', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '高级讲师', 2, 'https://online-teach-file.oss-cn-beijing.aliyuncs.com/teacher/2019/11/08/e44a2e92-2421-4ea3-bb49-46f2ec96ef88.png', 0, 0, '2020-08-03 16:44:36', '2020-08-08 21:51:10');
INSERT INTO `edu_teacher` VALUES ('999', '热巴', '清华大学经济学博士后，曾任中央银行行长、清华大学经管学院院长。', '初级讲师', 0, 'http://edu-longyang.oss-cn-beijing.aliyuncs.com/2020/08/05/74e33ab5bf8d46848cb5df9943a02c56file.png', 0, 0, '2020-07-27 17:18:04', '2020-08-04 17:18:08');
...
CREATE TABLE `edu_video`  (
  ...
  `course_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '课程ID',
  `chapter_id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '章节ID',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '节点名称',
  ...
  `sort` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '排序字段',
  `play_count` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '播放次数',
  `is_free` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否可以试听：0免费 1收费',
  ...
  `size` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '视频源文件大小（字节）',
  `version` bigint(20) UNSIGNED NULL DEFAULT 1 COMMENT '乐观锁',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `edu_video` VALUES ('1571388797800251394', '1571388543096946690', '1571388587221024770', '第一课', NULL, NULL, 0, 0, 0, 0, 'Empty', 0, 1, '2022-09-18 14:40:59', '2022-09-18 14:41:56');
INSERT INTO `edu_video` VALUES ('1571388836706615298', '1571388543096946690', '1571388587221024770', '第二课', 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/d730f435a0414542ad764f474c49689e-nihao.jpg', 'd730f435a0414542ad764f474c49689e-nihao', 0, 0, 0, 0, 'Empty', 0, 1, '2022-09-18 14:41:08', '2022-09-18 14:41:08');
INSERT INTO `edu_video` VALUES ('1571389085256876033', '1571388543096946690', '1571388587221024770', '第三课', 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/21199299ad7947eb9e2d0696d1857e75-222.png', '21199299ad7947eb9e2d0696d1857e75-222', 0, 0, 0, 0, 'Empty', 0, 1, '2022-09-18 14:42:08', '2022-09-18 14:42:08');
INSERT INTO `edu_video` VALUES ('1571389133571063809', '1571388543096946690', '1571388608188350465', '第一课', 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/44ac4e6a134e4e41ba40fa7ce7b61ea9-222.png', '44ac4e6a134e4e41ba40fa7ce7b61ea9-222', 0, 0, 0, 0, 'Empty', 0, 1, '2022-09-18 14:42:19', '2022-09-18 14:42:19');
INSERT INTO `edu_video` VALUES ('1571389163539365889', '1571388543096946690', '1571388608188350465', '第二课', 'https://liyaqiu-bucket.oss-cn-hangzhou.aliyuncs.com/238570161d734bfe93a3ced6415c5e6e-3.png', '238570161d734bfe93a3ced6415c5e6e-3', 0, 0, 0, 0, 'Empty', 0, 1, '2022-09-18 14:42:26', '2022-09-18 14:42:26');
...
-- ----------------------------
INSERT INTO `ucenter_member` VALUES ('1', NULL, '13700000001', 'e10adc3949ba59abbe56e057f20f883e', '小三123', 1, 5, 'https://img1.baidu.com/it/u=3217543765,3223180824&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1663347600&t=9416b3868e4f7e5e5a61ab34d1537c8a', NULL, 0, 0, '2019-01-01 12:11:33', '2019-11-08 11:56:01');
...
INSERT INTO `ucenter_member` VALUES ('1570027985550508034', NULL, '18813664703', '123456', '123', NULL, NULL, NULL, NULL, 0, 0, '2022-09-14 20:33:36', '2022-09-14 20:33:36');
